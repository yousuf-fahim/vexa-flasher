...
echo ================================================
echo    Flash VexaMiner to ESP32-2432S028R
echo    (Factory/Production Board)
echo ================================================
echo.
...
if not exist "firmware\dev\ESP32-2432S028R_factory.bin" (
    echo Factory firmware not found. Building...
    echo.
    C:\Users\FAHIM\.platformio\penv\Scripts\platformio.exe run -e ESP32-2432S028R
    if errorlevel 1 (
        echo.
    ...
    echo [OK] Found pre-built firmware: firmware\dev\ESP32-2432S028R_factory.bin
)
...
python C:\Users\FAHIM\.platformio\packages\tool-esptoolpy\esptool.py --chip esp32 --port !COMPORT! --baud 460800 --before default_reset --after hard_reset write_flash -z 0x0 firmware\dev\ESP32-2432S028R_factory.bin

if errorlevel 1 (
    echo.
    echo [WARN] Flash failed at high speed. Retrying at lower baud rate...
    python C:\Users\FAHIM\.platformio\packages\tool-esptoolpy\esptool.py --chip esp32 --port !COMPORT! --baud 115200 write_flash -z 0x0 firmware\dev\ESP32-2432S028R_factory.bin
...
echo ================================================
echo.
echo Board: ESP32-2432S028R (Factory/Production)
echo Note: This board has correct colors by default.
echo.
